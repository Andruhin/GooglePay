 ...
 * Required changes:
 *
 *  1.  Update DEFAULT_SUPPORTED_NETWORKS and SUPPORTED_METHODS if required (consult your processor if
 * unsure)
 *  1.  Update DEFAULT_CURRENCY_CODE to the currency you use.
 ...
 * PAYMENT_GATEWAY_TOKENIZATION_NAME and DEFAULT_PAYMENT_GATEWAY_TOKENIZATION_PARAMETERS per the
...
object Constants {
   ...
   *
   * @value #DEFAULT_SUPPORTED_NETWORKS
   */
   ...
   *
   * @value #DEFAULT_CURRENCY_CODE Your local currency
   */
   ...
   *
   * @value #DEFAULT_PAYMENT_GATEWAY_TOKENIZATION_PARAMETERS
   */
  val DEFAULT_PAYMENT_GATEWAY_TOKENIZATION_PARAMETERS = mapOf(
    "gateway" to PAYMENT_GATEWAY_TOKENIZATION_NAME,
    "gatewayMerchantId" to "store1"
  )
